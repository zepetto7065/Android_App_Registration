...
public class ScheduleFragment extends Fragment {
    ...
    private AutoResizeTextView monday[] = new AutoResizeTextView[14];//0~13교시
    private AutoResizeTextView tuesday[] = new AutoResizeTextView[14];//0~13교시
    private AutoResizeTextView wednesday[] = new AutoResizeTextView[14];//0~13교시
    private AutoResizeTextView thursday[] = new AutoResizeTextView[14];//0~13교시
    private AutoResizeTextView friday[] = new AutoResizeTextView[14];//0~13교시
        ...
        public void onPostExecute(String result){
            try {
                ...
                while(count < jsonArray.length()){
                    ...
                    System.out.println("4444444444444444444444444444444444444"+courseID+courseProfessor+courseTime+courseTitle);
